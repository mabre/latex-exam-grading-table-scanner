...
def copy_and_rename_images(images: list[Path], points: dict, base_path: Path):
    for image_path in images:
        ...
        if student_number in points:
            ...
            new_name = f"{timestamp}-{student_number}-{exercise_number}-{cell_index}.png" # if "student_number" is personal data, it should be removed; if it's a random number anyway, it may be included for easier correction of errors
